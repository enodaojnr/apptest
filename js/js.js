...
e.preventDefault();
$.ajax({
url: "handyserver.cloudapp.net/new/upload.php", // Url to which the request is send
type: "POST",
...
//alert("wat z wrng wit u")
 var username=localStorage.getItem("username");
		  ...
		  $.ajax({
		   type: "POST",
		   url: "http://handyserver.cloudapp.net/new/post.php",
...
//alert(usnm);
 var username=localStorage.getItem("username");
		  ...
		  $.ajax({
		   type: "POST",
		   url: "http://handyserver.cloudapp.net/new/calling.php",
...
function send()
{
 ...
 var username=$("#email").val();
		  ...
		  $.ajax({
		   type: "POST",
		   url: "http://handyserver.cloudapp.net/new/login1.php",
		   crossDomain:true,
			data:'name='+username+'&pwd='+password,
